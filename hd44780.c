...
hd44780_init(void)
{
  ...
  hd44780_wait_ready();
  hd44780_outnibble(HD44780_FNSET(0 /*4 bit interface*/, 1 /*two lines*/, 0 /*5x10 font*/) >> 4, 0);
  hd44780_wait_ready();
  hd44780_outcmd(HD44780_FNSET(0, 1, 0));
  hd44780_wait_ready();
  hd44780_outcmd(HD44780_DISPCTL(0 /*Display on*/, 0/*Cursor on*/, 0/*Cursor blinking*/));
   ...
   */
  hd44780_wait_ready();
  hd44780_outcmd(HD44780_ENTMODE(1 /*Increase data reg after print*/, 0 /*Display scrolling Off*/));

  /*
   * Enable display, activate cursor.
   */
  hd44780_wait_ready();
  hd44780_outcmd(HD44780_DISPCTL(1/* Display On*/, 1 /*Cursor On*/, 1 /*Cursor blink On*/));
}
